...
SELECT pg_catalog.setval('companiesuser_seq', 3, true);
...
--Start patch for maintenance_setting by seshu--
INSERT INTO maintenance_setting(
            id, maintenance_type_id, group_id, threshold)
    VALUES (1, 1, 2, 0);
INSERT INTO maintenance_setting(
            id, maintenance_type_id, group_id, threshold)
    VALUES (2, 2, 2, 0);
    INSERT INTO maintenance_setting(
            id, maintenance_type_id, group_id, threshold)
    VALUES (3, 3, 2, 0);
	--End patch for maintenance_setting by seshu--
...
--Start of patch for maintenance_setting (seshu)--
UPDATE maintenance_setting
   SET threshold='30000'
 WHERE id='1';
 UPDATE maintenance_setting
   SET threshold='30000'
...
UPDATE maintenance_setting
   SET threshold='30000'
 WHERE id='3';
 --End of  patch for maintenance_setting (Seshu)----
...
CREATE OR REPLACE FUNCTION usp_getrefrigerant_suplygroupname(IN groupids character varying)
  RETURNS TABLE(groupname character varying, supplygroupname character varying, groupid bigint, refid integer, supplygroupid bigint) AS
$BODY$
