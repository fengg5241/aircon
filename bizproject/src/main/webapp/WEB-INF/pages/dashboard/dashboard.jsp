...
<title><spring:message code="label.smart"/> | <spring:message code="label.dash"/></title>
...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div id="dashboardViewFrame">
					<%@ include
						file="../../../assets/template/dashboard/dashboardHomeScreen.jsp"%>
				</div>
			</div>
		</div><br>
		<%@ include file="../../../assets/template/common/footer.jsp" %>
		<input id="curPageNameHidden" type="hidden" value="homeScreen">
		<input id="companyIdHidden" type="hidden" value="${sessionInfo.companyId}">
		<input id="useridname" type="hidden" value="${sessionInfo.loginId}">
	</div>
	...
	<!-- <script src="../assets/js/plugins/highcharts/modules/exporting.js"></script>
		<script src="../assets/js/plugins/highcharts/modules/export-csv.js"></script> -->
...
<!-- 	<script src="../assets/js/plugins/jsTree/jstree.min.js"></script> -->
	<!-- skycons -->
	<script src="../assets/js/plugins/skycons/skycons.min.js"></script>
	<!-- Peity -->
