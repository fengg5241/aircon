...
<title><spring:message code="label.notificationtitle" /></title>
...
<body>
 		...
 		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="row">
				...
				<div class="rightViewFrame">
					<%@ include
						file="../../../assets/template/notification/notificationView.jsp"%> 
				</div>
			</div>
		</div>
	...
	<!-- High Charts -->
		...
		<script src="../assets/js/plugins/highcharts/highcharts-custom.js"></script>
		 <!-- <script src="../assets/js/plugins/highcharts/modules/no-data-to-display.js"></script>
		<script src="../assets/js/plugins/highcharts/modules/no-data-to-display.src.js"></script> -->
