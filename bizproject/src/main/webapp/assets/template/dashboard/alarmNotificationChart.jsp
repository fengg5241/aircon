		...
		<div class="ibox-content">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab"
					href="#sort_notifications"><i class="fa fa-sort-amount-desc"></i>Notification
						Rank</a></li>
				...
				<div id="sort_notifications" class="tab-pane active">
					...
					<div class="row  m-t-sm" style="margin-top: -5px;">
						...
						<div class="col-sm-4" style="display: none;" id="graph">
							<div class="icon-type pull-right">
								<i class="pull-middle fa fa-bar-chart-o" title="Graph View"
									style="font-size: 25px;"> </i>
							</div>
						</div>
						<div class="col-sm-12" id="graphs">
							<div class="graphs" id="statistics_graphs"></div>
						</div>
						<div class="col-sm-12" id="tables" style="display: none;">
								...
								<table class="table table-striped table-hover">
									<tbody>
										<tr>
											...
											<td class="icon-type"><i class="pull-middle fa fa-bell"
