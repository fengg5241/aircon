...
/**
 * The persistent class for the power_consumption_capacity database table.
 * 
 */
@Entity
@Table(name="power_consumption_capacity")
@NamedQuery(name="PowerConsumptionCapacity.findAll", query="SELECT p FROM PowerConsumptionCapacity p")
public class PowerConsumptionCapacity implements Serializable {
	...
	public PowerConsumptionCapacity() {
	}
