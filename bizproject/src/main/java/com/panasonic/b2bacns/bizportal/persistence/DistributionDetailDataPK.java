...
/**
 * The primary key class for the distribution_detail_data database table.
 * 
 */
@Embeddable
public class DistributionDetailDataPK implements Serializable {
	...
	public DistributionDetailDataPK(Long cutoffreqId, String deviceOid) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DistributionDetailDataPK)) {
			return false;
		}
		DistributionDetailDataPK castOther = (DistributionDetailDataPK) other;
		return this.cutoffreqId.equals(castOther.cutoffreqId)
