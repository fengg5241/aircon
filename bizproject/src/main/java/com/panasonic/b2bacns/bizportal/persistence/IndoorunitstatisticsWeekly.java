...
/**
 * The persistent class for the indoorunitstatistics_weekly database table.
 * 
 */
@Entity
@Table(name="indoorunitstatistics_weekly")
@NamedQuery(name="IndoorunitstatisticsWeekly.findAll", query="SELECT i FROM IndoorunitstatisticsWeekly i")
public class IndoorunitstatisticsWeekly implements Serializable {
	...
	public IndoorunitstatisticsWeekly() {
	}
