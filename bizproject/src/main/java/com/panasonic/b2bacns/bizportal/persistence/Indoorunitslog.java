...
/**
 * The persistent class for the indoorunitslog database table.
 * 
 */
@Entity
@Table(name="indoorunitslog")
@NamedQuery(name="Indoorunitslog.findAll", query="SELECT i FROM Indoorunitslog i")
public class Indoorunitslog implements Serializable {
