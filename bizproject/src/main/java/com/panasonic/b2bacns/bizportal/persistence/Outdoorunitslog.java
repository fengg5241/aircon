...
/**
 * The persistent class for the outdoorunitslog database table.
 * 
 */
@Entity
@Table(name="outdoorunitslog")
@NamedQuery(name="Outdoorunitslog.findAll", query="SELECT o FROM Outdoorunitslog o")
public class Outdoorunitslog implements Serializable {
