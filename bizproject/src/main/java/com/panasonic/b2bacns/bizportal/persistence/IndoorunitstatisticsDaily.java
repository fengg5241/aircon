...
/**
 * The persistent class for the indoorunitstatistics_daily database table.
 * 
 */
@Entity
@Table(name="indoorunitstatistics_daily")
@NamedQuery(name="IndoorunitstatisticsDaily.findAll", query="SELECT i FROM IndoorunitstatisticsDaily i")
public class IndoorunitstatisticsDaily implements Serializable {
	...
	public IndoorunitstatisticsDaily() {
	}
