...
/**
 * The persistent class for the power_consumption_capacity_weekly database table.
 * 
 */
@Entity
@Table(name="power_consumption_capacity_weekly")
@NamedQuery(name="PowerConsumptionCapacityWeekly.findAll", query="SELECT p FROM PowerConsumptionCapacityWeekly p")
public class PowerConsumptionCapacityWeekly implements Serializable {
	...
	public PowerConsumptionCapacityWeekly() {
	}
