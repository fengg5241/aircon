...
/**
 * The persistent class for the indoorunitstatistics database table.
 * 
 */
@Entity
@Table(name="indoorunitstatistics")
@NamedQuery(name="Indoorunitstatistic.findAll", query="SELECT i FROM Indoorunitstatistic i")
public class Indoorunitstatistic implements Serializable {
