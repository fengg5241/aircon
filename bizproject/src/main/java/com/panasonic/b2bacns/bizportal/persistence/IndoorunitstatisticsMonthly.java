...
/**
 * The persistent class for the indoorunitstatistics_monthly database table.
 * 
 */
@Entity
@Table(name="indoorunitstatistics_monthly")
@NamedQuery(name="IndoorunitstatisticsMonthly.findAll", query="SELECT i FROM IndoorunitstatisticsMonthly i")
public class IndoorunitstatisticsMonthly implements Serializable {
	...
	public IndoorunitstatisticsMonthly() {
	}
